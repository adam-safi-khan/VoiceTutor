 ...
 * Features:
 * - Animated slide-in as each topic is introduced via function call
...
export default function TopicSelector({ topics, selectedOption, onDismiss }: TopicSelectorProps) {
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-4">
        ...
        {!selectedOption && topics.length < 3 && (
          ...
          return (
            <div
              ...
              className={`
                ...
                ${topic ? 'animate-slide-in-up' : 'opacity-30 border-dashed'}
                ${isSelected 
